...
namespace Infrastructure.Forms.DependencyInjection
{
    public class Container
    {
        ...
        {
            this.ObjectCollection.Add(from, new ContainerObjectMeta(from, to, instance, lifetime));
        }

        private Dictionary<Type, ContainerObjectMeta> _objectCollection;
        private Dictionary<Type, ContainerObjectMeta> ObjectCollection 
        { 
            get
            {
                return (_objectCollection != null ? _objectCollection : 
                    _objectCollection = new Dictionary<Type, ContainerObjectMeta>());
            }
